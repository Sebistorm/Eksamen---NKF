(function () {
    ...
    */
        ...
        if (c || eb) {
            ...
            var fb = function (c, d) {
                ...
                pa = Node.prototype.cloneNode = function (b) {
                    if (!e &&
                        d && this instanceof DocumentFragment)
                        if (b) var c = qa.call(this.ownerDocument, this, !0);
                        else return this.ownerDocument.createDocumentFragment();
                    else c = this.nodeType === Node.ELEMENT_NODE && "template" === this.localName ? a.ca(this, b) : f.call(this, b);
                    b && fb(c, this);
                    return c
                },
    ...
    var la = 0,
        ma, ra = "undefined" !== typeof window ? window : void 0,
        sa = ra || {},
    ...
    function gb(a, b) {
        ...
        this.A[Na] || Oa(this.A);
        if (ka(b))
            if (this.S = this.length = b.length, this.f = Array(this.length), 0 === this.length) r(this.A, this.f);
            else {
    ...
    function v(a) {
        ...
        if (Ma !== a) {
            ...
            if (this instanceof v) cb(this, a);
    ...
    */
    ...
    var nb = document.querySelector('script[src*="webcomponents-lite.js"]'),
        ob = /wc-(.+)/,
        w = {};
    if (!w.noOpts) {
        ...
        if (nb)
            for (var pb = 0, qb; qb = nb.attributes[pb]; pb++) "src" !== qb.name && (w[qb.name] = qb.value || !0);
    ...
    */
    ...
    function Ec(a) {
        if (a.__shady && void 0 !== a.__shady.ka)
            for (var b = a.childNodes, c = 0, d = b.length, e; c < d && (e = b[c]); c++) Ec(e);
    ...
    function Hc(a, b) {
        if ("slot" === b) a = a.parentNode, Bc(a) && Ac(a.__shady.root);
        else if ("slot" === a.localName && "name" === b && (b = wb(a))) {
            var c = a.Aa,
                d = Ic(a);
            if (d !== c) {
                c = b.l[c];
    ...
    function Yc(a, b, c) {
        if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c])
            for (var d = 0, e;
                (e = c[d]) && (!Xc(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.h); d++);
    }
    ...
    function Zc(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (0 === c || f && f === e)
                if (Yc(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
        }
    }
                ...
                if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                    ...
                    k = function (e) {
                        ...
                        if (e.composed || -1 < e.composedPath().indexOf(g))
                            if (Xc(e) && e.target === e.relatedTarget) e.eventPhase === Event.BUBBLING_PHASE && e.stopImmediatePropagation();
    ...
    H.prototype._renderRoot = function () {
        ...
        for (a = 0; a < this.o.length; a++) {
            ...
            if (!b.__shady.assignedNodes.length)
                for (c = b.firstChild; c; c = c.nextSibling) md(this,
                    c, b);
            c = b.parentNode;
        ...
        for (a = 0; a < b.length; a++) {
            ...
            for (k = 0; k < h.length && (c = h[k]); k++)
                for (g = f[c.index], l = c.index; l < c.index + c.U; l++) m = e[l], A.insertBefore.call(d, m, g), f.splice(l, 0, m)
        }
    };
    ...
    Object.defineProperties(yd, {
        _activeElement: tc.activeElement
    });
            ...
            if (d.nodeType === Node.ELEMENT_NODE) {
                ...
                if ("link" === f && "import" === e.getAttribute("rel")) {
                    ...
                    if (d instanceof Node && !c.has(d))
                        for (c.add(d), d = d.firstChild; d; d = d.nextSibling) L(d, b, c);
                    d = Ed(a, e);
                    continue
                } else if ("template" === f) {
                    d = Ed(a, e);
                ...
                if (e = e.__CE_shadowRoot)
                    for (e = e.firstChild; e; e = e.nextSibling) L(e, b, c)
            }
    ...
    Kd.prototype.b = function (a) {
        ...
        for (b = 0; b < a.length; b++)
            for (var c = a[b].addedNodes, d = 0; d < c.length; d++) P(this.j, c[d])
    };
    ...
    var Nd = window.Document.prototype.createElement,
    ...
    function ue(a, b, c) {
        function d(b) {
            return function (c) {
                ...
                if (K(this))
                    for (d = 0; d < e.length; d++) f = e[d], f instanceof Element && N(a, f)
            }
        }
    ...
    function we() {
        ...
        M(Node.prototype, "appendChild", function (b) {
            if (b instanceof DocumentFragment) {
                ...
                b = Vd.call(this, b);
                if (K(this))
                    for (var e = 0; e < c.length; e++) N(a, c[e]);
                return b
            }
            c = K(b);
            e = Vd.call(this, b);
        ...
        M(Node.prototype, "replaceChild", function (b, d) {
            if (b instanceof DocumentFragment) {
                ...
                b = Yd.call(this, b, d);
                if (K(this))
                    for (O(a, d), d = 0; d < c.length; d++) N(a, c[d]);
                return b
            }
            c = K(b);
            var f = Yd.call(this, b, d),
                h = K(this);
            h && O(a, d);
            c && O(a, b);
            h && N(a, b);
    ...
    function xe(a) {
        ...
        function c(b) {
            return function (c) {
                ...
                if (K(this))
                    for (d = 0; d < e.length; d++) g = e[d], g instanceof Element && N(a, g)
            }
        }
        ...
        void 0 !==
            me && M(b, "replaceWith", function (b) {
                ...
                if (g)
                    for (O(a, this), c = 0; c < d.length; c++) h = d[c], h instanceof Element && N(a, h)
            });
    ...
    if (!ze || ze.forcePolyfill || "function" != typeof ze.define || "function" != typeof ze.get) {
        ...
        se();
        ve();
        ue(te, DocumentFragment.prototype, {
            X: Sd,
            append: Td
        });
        we();
    ...
    function Ee(a, b) {
        ...
        if (c = a.rules)
            for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) Ee(f,
                b);
        return a
    }
    ...
    function kf(a, b, c, d) {
        ...
        if (b = "template" === b.localName ? (b.content || b.gb).childNodes : b.children || b.childNodes)
            for (var e = 0; e < b.length; e++) kf(a, b[e], c, d)
    }
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        ...
                        h = g;
                        g = h.indexOf(W.a);
                        if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument) jf(e, h, !0);
                        else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
                            (f = f.host))
                            if (f = V(f).is, h === f)
                                for (e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.a + ")"), f = 0; f < e.length; f++) lf(e[f], h);
    ...
    if (!R) {
        ...
        if (window.customElements && !window.customElements.polyfillWrapFlushCallback) kg(document);
        else {
            var lg = function () {
                kg(document.body)
            };
            ...
            if (this.b.enqueued) {
                if (S)
                    for (var b = 0; b < a.length; b++) {
                        ...
                        for (zg(this, this.c, this.h), b = 0; b < a.length; b++)(c = this.b.getStyleForCustomStyle(a[b])) && bg(c, this.h.B);
                this.b.enqueued = !1;
    ...
    var Dg = window.customElements,
        Eg = window.HTMLImports,
        Fg = window.HTMLTemplateElement;
    window.WebComponents = window.WebComponents || {};
